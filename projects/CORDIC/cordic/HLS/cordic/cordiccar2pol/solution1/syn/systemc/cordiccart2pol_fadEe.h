...
// ==============================================================
#ifndef __cordiccart2pol_fadEe__HH__
#define __cordiccart2pol_fadEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordiccart2pol_fadEe) {
    ...
    SC_CTOR(cordiccart2pol_fadEe):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

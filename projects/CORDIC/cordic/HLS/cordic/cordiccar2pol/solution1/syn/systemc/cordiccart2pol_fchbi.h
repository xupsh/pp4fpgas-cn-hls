...
// ==============================================================
#ifndef __cordiccart2pol_fchbi__HH__
#define __cordiccart2pol_fchbi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordiccart2pol_fchbi) {
    ...
    SC_CTOR(cordiccart2pol_fchbi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);

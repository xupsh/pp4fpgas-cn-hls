...
architecture behave of fir_ap_start_s_axi is
    ...
    constant ADDR_Y_V_DATA_0 : INTEGER := 16#10#;
    constant ADDR_Y_V_CTRL   : INTEGER := 16#14#;
    constant ADDR_X_V_DATA_0 : INTEGER := 16#18#;
    constant ADDR_X_V_CTRL   : INTEGER := 16#1c#;

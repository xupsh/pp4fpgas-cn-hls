...
#
# 1. This project restoration tcl script (build_cordic.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/wenchen/workspace/Lab1_cordic/Cordic_overlay/Cordic_overlay.srcs/sources_1/bd/cordic/hdl/cordic_wrapper.v"
#
...
set project_name "Cordic_overlay"
...
set script_file "build_cordic.tcl"
...
set files [list \
 "[file normalize "cordic_wrapper.v"]"\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "cordic_wrapper" -objects $obj
...
# Proc to create BD cordic
proc cr_bd_cordic { parentCell } {
 ...
 ] [get_bd_intf_pins /cordic_0/s_axi_AXILiteS]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins cordic_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cordic_0/s_axi_AXILiteS/Reg] SEG_cordic_0_Reg
...
# End of cr_bd_cordic()
cr_bd_cordic ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files cordic.bd ]

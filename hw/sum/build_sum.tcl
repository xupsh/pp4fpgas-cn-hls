...
#
# build_sum.tcl: Tcl script for re-creating project 'sum_overlay'
#
# Generated by Vivado on Sat Oct 06 17:25:22 +0800 2018
...
#
# 1. This project restoration tcl script (build_sum.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/wenchen/workspace/Lab8_sum/sum_overlay/sum_overlay.srcs/sources_1/bd/sum/hdl/sum_wrapper.v"
#
...
set obj [get_filesets sources_1]
set_property -name "top" -value "sum_wrapper" -objects $obj
...
# Proc to create BD sum
proc cr_bd_sum { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins sum_0/ap_rst_n]
...
# End of cr_bd_sum()
cr_bd_sum ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files sum.bd ]

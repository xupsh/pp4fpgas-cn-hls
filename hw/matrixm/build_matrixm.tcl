...
#
# build_matrixm.tcl: Tcl script for re-creating project 'matrixm_overlay'
#
# Generated by Vivado on Thu Oct 04 19:35:35 +0800 2018
...
#
# 1. This project restoration tcl script (build_matrixm.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/wenchen/workspace/Lab7_matrix/matrixm_overlay/matrixm_overlay.srcs/sources_1/bd/matrixm/hdl/matrixm_wrapper.v"
#
...
set project_name "matrixm_overlay"
...
set script_file "build_matrixm.tcl"
...
set files [list \
 "[file normalize "matrixm_wrapper.v"]"\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "matrixm_wrapper" -objects $obj
...
# Proc to create BD matrixm
proc cr_bd_matrixm { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name matrixm
  ...
  # Create instance: matrixm_0, and set properties
  set matrixm_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matrixm:1.0 matrixm_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matrixm_0/A]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins matrixm_0/B]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_1/M00_AXI]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins matrixm_0/ap_rst_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
# End of cr_bd_matrixm()
cr_bd_matrixm ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files matrixm.bd ]

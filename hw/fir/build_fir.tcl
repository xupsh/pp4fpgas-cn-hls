...
#
# 1. This project restoration tcl script (build_fir.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/wenchen/workspace/Lab2_FIR/FIR_overlay/FIR/FIR.srcs/sources_1/bd/FIR/hdl/fir_wrapper.v"
#
...
set obj [get_filesets sources_1]
set_property -name "top" -value "fir_wrapper" -objects $obj
...
# Proc to create BD FIR
proc cr_bd_FIR { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fir_0/s_axi_x_axilite] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins fir_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
# End of cr_bd_FIR()
cr_bd_FIR ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files FIR.bd ]

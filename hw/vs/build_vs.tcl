...
#
# build_vs.tcl: Tcl script for re-creating project 'vs_overlay'
#
# Generated by Vivado on Wed Oct 10 18:03:33 SGT 2018
...
#
# 1. This project restoration tcl script (build_vs.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/lettertu/Templates/vs/vs_overlay/vs_overlay/vs_overlay.srcs/sources_1/bd/vs/hdl/vs_wrapper.v"
#
...
set obj [get_filesets sources_1]
set_property -name "top" -value "vs_wrapper" -objects $obj
...
# Proc to create BD vs
proc cr_bd_vs { parentCell } {
  ...
  # Create instance: vs_0, and set properties
  set vs_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:vs:1.0 vs_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins vs_0/pixel_in_R]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins vs_0/pixel_in_G]
  ...
  connect_bd_intf_net -intf_net axi_dma_2_M_AXIS_MM2S [get_bd_intf_pins axi_dma_2/M_AXIS_MM2S] [get_bd_intf_pins vs_0/pixel_in_B]
  ...
  connect_bd_intf_net -intf_net vs_0_pixel_out_B [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM] [get_bd_intf_pins vs_0/pixel_out_B]
  connect_bd_intf_net -intf_net vs_0_pixel_out_G [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins vs_0/pixel_out_G]
  connect_bd_intf_net -intf_net vs_0_pixel_out_R [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins vs_0/pixel_out_R]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins vs_0/ap_rst_n]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_mm2s_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_interconnect_0/S05_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins vs_0/ap_clk]
...
# End of cr_bd_vs()
cr_bd_vs ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files vs.bd ]

...
#
# 1. This project restoration tcl script (build_fft.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/wenchen/workspace/Lab3_dft/fft_wrapper/fft_wrapper.srcs/sources_1/bd/fft/hdl/fft_wrapper.v"
#
...
set obj [get_filesets sources_1]
set_property -name "top" -value "fft_wrapper" -objects $obj
...
# Proc to create BD fft
proc cr_bd_fft { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins fft_0/sample_real]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins fft_0/sample_imag]
  ...
  connect_bd_intf_net -intf_net fft_0_out_imag [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins fft_0/out_imag]
  connect_bd_intf_net -intf_net fft_0_out_real [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins fft_0/out_real]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins fft_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
# End of cr_bd_fft()
cr_bd_fft ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files fft.bd ]

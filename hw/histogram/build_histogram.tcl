...
#
# build_histogram.tcl: Tcl script for re-creating project 'histogram_overlay'
#
# Generated by Vivado on Sat Oct 06 20:49:26 +0800 2018
...
#
# 1. This project restoration tcl script (build_histogram.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/wenchen/workspace/Lab8_histogram/histogram_overlay/histogram_overlay.srcs/sources_1/bd/histogram/hdl/histogram_wrapper.v"
#
...
set project_name "histogram_overlay"
...
set script_file "build_histogram.tcl"
...
set files [list \
 "[file normalize "histogram_wrapper.v"]"\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "histogram_wrapper" -objects $obj
...
# Proc to create BD histogram
proc cr_bd_histogram { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name histogram
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins histogram_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins histogram_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
# End of cr_bd_histogram()
cr_bd_histogram ""
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files histogram.bd ]
